  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#111111] border border-[#2a2a2a] rounded-2xl p-8 shadow-2xl">
        ...
        {/* Google (UI only) */}
        <button
          className="w-full h-11 rounded-lg border border-[#2a2a2a] bg-[#0a0a0a] text-sm text-white flex items-center justify-center gap-3 hover:border-[#3a3a3a] transition-colors"
